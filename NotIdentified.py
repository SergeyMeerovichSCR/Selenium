...
class NotIdentifiedNavigationFirefox(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_2_Not_Identified_Report_Firefox(self):
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Navigation to Not Identified Cows Report on_Firefox started at :'+date_time_formatted
        try:
           #Open Not Identofied report
           not_id_link=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[@class='tab-content']/div[@id='dashboard-pane']/div[@class='statistics']/div[@class='row-fluid']/div[1]/div[2]/div[1]/a[@class='not_identified']")
           not_id_link.click()
           self.driver.implicitly_wait(10)
        except NoSuchElementException:
             self.take_screenshot('Fail_click_on_Not_ID_web_link')
             self.fail("There is missing element 'not ID' ")
        try:
           #Check if user get a title 'Choose Report'
           self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[1]/div[@id='data-pane']/div[@id='list']/div[@id='list_header']/div[@id='title']")),"Do not opened Report list")
           #Ceck if user get focus and opened No ID report
           self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[1]/div[@id='data-pane']/div[@id='list']/div[@id='filters-container']/ul/li[@data-report='NoId']")),"Do not find Not ID button")
           NotIDBtn=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[1]/div[@id='data-pane']/div[@id='list']/div[@id='filters-container']/ul/li[@data-report='NoId']")
           checkBtnActive=NotIDBtn.get_attribute('class')
           self.assertEqual(checkBtnActive,'report btn active','button class contain text active')
        except NoSuchElementException:
             self.take_screenshot('Fail_load_Reports_page')
             self.fail("There is missing element 'not ID' ")
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Navigation to Not ID Cows Report on_Firefox finish at :'+date_time_formatted
...
class NotIdentifiedNavigationChrome(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_1_Login_process_on_Chrome(self):
        ...
        while(loading_attempt>0):
             ...
             try:
              ...
              self.take_screenshot('Fail_not_all_elements_loaded_on_Dashboard')
    ...
    def test_2_Not_Identified_Report_Chrome(self):
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Navigation to Not Identified Cows Report on_Chrome started at :'+date_time_formatted
        try:
           #Open Not Identofied report
           not_id_link=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[@class='tab-content']/div[@id='dashboard-pane']/div[@class='statistics']/div[@class='row-fluid']/div[1]/div[2]/div[1]/a[@class='not_identified']")
           not_id_link.click()
        ...
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Navigation to Not ID Cows Report on_Crome finish at :'+date_time_formatted
...
class NotIdentifiednavigationIE(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_2_Not_Identified_Report_IE(self):
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Navigation to Not Identified Cows Report on_IE started at :'+date_time_formatted
        try:
           not_id=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[@class='tab-content']/div[@id='dashboard-pane']/div[@class='statistics']/div[@class='row-fluid']/div[1]/div[2]/div[1]/a[@class='not_identified']")
           self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[@class='tab-content']/div[@id='dashboard-pane']/div[@class='statistics']/div[@class='row-fluid']/div[1]/div[2]/div[1]/a[@class='not_identified']").send_keys(Keys.NULL)
           self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[@class='tab-content']/div[@id='dashboard-pane']/div[@class='statistics']/div[@class='row-fluid']/div[1]/div[2]/div[1]/a[@class='not_identified']").send_keys(Keys.ENTER)
           date_time=datetime.now()
           date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
           print 'Test Navigation to Not ID Cows Report on_IE finish at :'+date_time_formatted
        except NoSuchElementException:
             self.take_screenshot('Fail load Reports page')
             self.fail("There is missing element 'not ID' or can not click on it ")
        #Check if No Id report opened and it focus on it
        try:
           #Check if user get a title 'Choose Report'
           ...
           #Ceck if user get focus and opened No ID report
           self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[1]/div[@id='data-pane']/div[@id='list']/div[@id='filters-container']/ul/li[@data-report='NoId']")),"Not find Not ID button")
           NotIDBtn=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[1]/div[1]/div[@id='data-pane']/div[@id='list']/div[@id='filters-container']/ul/li[@data-report='NoId']")
           checkBtnActive=NotIDBtn.get_attribute('class')
           self.assertEqual(checkBtnActive,'report btn active','button class contain text active')
        except NoSuchElementException:
