...
class SettingsTabSwitchTestFirefox(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_2_Switch_tabs_on_Settings_page_on_Firefox(self):
        #test_2DashboardDataSwitch_process_on_Firefox
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Switch_Account_tab_todevices_tab_on_Settings_on_Firefox started at :'+date_time_formatted
        ...
        # Switch throw  'Settings' tabs Account/Devices/Alerts
        for x in range(0,20):
        #switch to 'Devices' tab
           try:
             ...
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='devices']/a")),"Do not find Devices tab button on Settings window")
             devices_tab.click()
             self.driver.implicitly_wait(10)
             #check if "add device" button exsist
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-devices']/div[@class='device-list']/div[@class='sub-title']/input[@id='btnAddNonScrDevice']")),"Not all elements loaded on Devices tab")
             #check if Registration key exsist on Devices tab
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-devices']/div[@class='device-list']/div[@class='device-container']/div[@id='deviceKey']")),"Do not loaded Device key number on Devices tab")
           except NoSuchElementException:
        ...
        #switch to Alerts tab
           try:
             alerts_tab=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='alerts']/a")
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='alerts']/a")),"Do not find Alerts tab button on Settings window")
             alerts_tab.click()
             self.driver.implicitly_wait(10)
             #check if Save/Cancel and Add another number/Add another email address elements exsist
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-alerts']/form[@id='frmAlerts']/div[@class='button-container']/input[@id='btnUserAlertSave']")),"Do not find Save button on Alerts-tab...")
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-alerts']/form[@id='frmAlerts']/div[@class='button-container']/input[@id='btnUserAlertCancel']")),"Do not find Cancel button on Alerts-tab...")
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-alerts']/form[@id='frmAlerts']/div[@class='fields-form']/div[3]/div[@class='both']/a[@class='add-alert-phone-number-link']")),"Do not find Add another number drop-down link...")
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-alerts']/form[@id='frmAlerts']/div[@class='fields-form']/div[6]/div[@class='both']/a[@class='add-email-link']")),"Do not find Add another email address drop-down link...")
           except NoSuchElementException:
             self.take_screenshot("Can not find 'Settings/Alerts' tab-button problem")
             self.fail("There is missing element on 'settings window'")
           try:
             #check if user located on 'account' tab
             account_tab=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='account']/a")
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='account']/a")),"Do not find Account tab link-button")
             account_tab.click()
             self.driver.implicitly_wait(10)
             #check if Edit button exsist
             self.assertTrue(self.is_element_present(By.XPATH,("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/div[@class='tab-content']/div[@id='div-account']/form[@id='frmSetting']/input[@id='btnAccountEdit']")),"Do not find Edit button...")
           except NoSuchElementException:
             self.take_screenshot("Can not find 'settings/account' elements")
             self.fail("There is missing element 'settings'")
        print "Test running time:"+str((date_time.now()-date_time))
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Switch_tabs_on_settings_on_Firefox finish at :'+date_time_formatted
...
class SettingsTabSwitchTestChrome(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_2_Switch_tabs_on_Settings_page_on_Chrome(self):
        #test_2DashboardDataSwitch_process_on_Firefox
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Switch_Account_tab_todevices_tab_on_Settings_on_Firefox started at :'+date_time_formatted
        ...
        #switch to 'Devices' tab
           try:
             ...
             self.take_screenshot("Can_not_find_Settings_Devices_tab_button_problem")
             self.fail("There is missing element on 'settings window'")
        #switch to Alerts tab
           try:
             alerts_tab=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='alerts']/a")
             ...
             self.take_screenshot("Can_not_find_Settings_Alerts_tab_button_problem")
             self.fail("There is missing element on 'settings window'")
           try:
             #check if user located on 'account' tab
             account_tab=self.driver.find_element_by_xpath("//html/body[@id='top']/div[@id='wrap']/div[@id='app']/div[2]/div[@class='signup-container']/div[2]/div[3]/ul/li[@class='account']/a")
             ...
             self.take_screenshot("Can_not_find_settings_account_elements")
             self.fail("There is missing element 'settings'")
        print "Test running time:"+str((date_time.now()-date_time))
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Switch_tab_on_Settings_process_on_Chrome finish at :'+date_time_formatted
...
class SettingsTabSwitchTestIE(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        #get path of chromedriver
        dir=os.path.dirname(__file__)
    ...
    def test_2_Switch_tabs_on_Settings_page_on_IE(self):
        #test_2DashboardDataSwitch_process_on_Firefox
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Switch_Account_tab_todevices_tab_on_Settings_on_Firefox started at :'+date_time_formatted
        ...
        date_time=datetime.now()
        date_time_formatted=date_time.strftime("%d/%m/%Y  %H:%M:%S")
        print 'Test Switch_tabs_onSettings_process_on_IE finish at :'+date_time_formatted
